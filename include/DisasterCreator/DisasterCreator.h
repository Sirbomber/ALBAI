...
class DisasterCreator
{
	public:
		...
		void SetCallbackTrigger(char const *callback, int Delay);						// Creates a time trigger, using the specified delay and callback function.
		void SetCallbackTrigger(char const *callback, int minDelay, int maxDelay);		// Creates a time trigger, using the specified delay and callback function.
